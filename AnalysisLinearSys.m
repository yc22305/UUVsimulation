...
%     h12 = plot(nominal_Z_setting(idx),rG11(imag(rG11)==0),'r.'); hold on,
%     figure(2),
%     h21 = plot(nominal_Z_setting(idx),2*abs(rG12(imag(rG12)~=0)),'b.'); hold on,
%     h22 = plot(nominal_Z_setting(idx),rG12(imag(rG12)==0),'r.'); hold on,
%     figure(3),
%     h31 = plot(nominal_Z_setting(idx),2*abs(rG21(imag(rG21)~=0)),'b.'); hold on,
%     h32 = plot(nominal_Z_setting(idx),rG21(imag(rG21)==0),'r.'); hold on,
%     figure(4),
%     h41 = plot(nominal_Z_setting(idx),2*abs(rG22(imag(rG22)~=0)),'b.'); hold on,
%     h42 = plot(nominal_Z_setting(idx),rG22(imag(rG22)==0),'r.'); hold on,
% end
